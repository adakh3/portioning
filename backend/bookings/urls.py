...
urlpatterns = [
    ...
    path('bookings/cron/run-first-responses/', CronRunFirstResponsesView.as_view(), name='cron-run-first-responses'),
    ...
    path('bookings/cron/sync-meta-leads/', MetaLeadsCronView.as_view(), name='cron-sync-meta-leads'),
]
