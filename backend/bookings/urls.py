...
from bookings.views import (
    ...
    UserListView, ProductLineListView, LeadListCreateView, LeadDetailView, LeadTransitionView, LeadConvertView, LeadBulkUpdateView, LeadActivityView, LeadAutoAssignView,
    DashboardStatsView,
