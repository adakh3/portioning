          ...
          <div className="ml-auto flex items-center gap-3 shrink-0">
            ...
            <div className="relative" ref={menuRef}>
              {/* Settings, Team and the rest of the admin tooling live ONLY behind
                  ...
                  Settings after the nav moved here. It is now a bordered control
                  with a hamburger — the universal "menu lives here" affordance —
                  and it announces itself to assistive tech as a menu button. */}
              <button
