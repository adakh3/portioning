...
import MyTargetsPanel from "./MyTargetsPanel";
...
describe("MyTargetsPanel", () => {
  it("leads with the target — period and attainment", () => {
    render(<MyTargetsPanel />);
  ...
  it("renders nothing while loading (doesn't block the dashboard)", () => {
    commissionReturn = { data: undefined, error: null, isLoading: true };
    const { container } = render(<MyTargetsPanel />);
